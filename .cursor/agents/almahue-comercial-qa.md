...
3. Comprobar en **UI live**: Cotizaciones Compras → OC (no NP); OV Ventas → confirmar stock → factura (sin cadena); splits bodega; lookup RUT + flag productor (no maestro). Admin › Empresas **sin** combo venta bajo costo.
