...
3. **No clasificar como defecto nuevo (ya cerrado en código local):** cadena OV (D4); wizard Emitir tipos (solo FACTURA/NC/ND/GUIA); catálogo vs Sidebar Cotizaciones/OV; `ventaBajoCosto` **tiene** UI; montaje Libro de compras; Emitir-desde-OV sin cuenta obligatoria en piloto.
